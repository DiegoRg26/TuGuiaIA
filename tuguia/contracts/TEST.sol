...
function registerVendor(address _vendorAddress, string memory _name, uint256 _nit, uint256 _idNegocio) public {
    require(msg.sender == admin, "Solo el administrador puede registrar vendedores");
    vendors[_vendorAddress] = Vendor(_name, _nit, false, _idNegocio);  
}
